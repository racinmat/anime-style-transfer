...
\todo{One way to overcome this obstacle is to use technique such as spatial pyramid pooling~\cite{spatialpool}, however it is not siutable for a point cloud representation since the dimensions of such point cloud will be n$\times$3.
