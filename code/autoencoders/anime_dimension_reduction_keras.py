...
def prepare_network(lr, decay):
    ...
    out = Conv2D(64, kernel_size=7, strides=2, activation='elu', padding='same', name='encoder_2')(out)
    out = Conv2D(128, kernel_size=7, strides=2, activation='elu', padding='same', name='encoder_3')(out)
    # out = Conv2D(256, kernel_size=7, strides=2, activation='elu', padding='same')(out)
    # out = Conv2D(256, kernel_size=7, strides=2, activation='elu', padding='same')(out)
    ...
    # out = Conv2DTranspose(256, kernel_size=7, strides=2, activation='elu', padding='same')(out)
    # out = Conv2DTranspose(128, kernel_size=7, strides=2, activation='elu', padding='same')(out)
    out = Conv2DTranspose(64, kernel_size=7, strides=2, activation='elu', padding='same', name='decoder_3')(out)
    out = Conv2DTranspose(32, kernel_size=7, strides=2, activation='elu', padding='same', name='decoder_2')(out)
