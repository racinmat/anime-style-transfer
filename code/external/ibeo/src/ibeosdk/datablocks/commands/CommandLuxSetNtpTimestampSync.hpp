//======================================================================
/*! \file CommandLuxSetNtpTimestampSync.hpp
 *
 * \copydoc Copyright
 * \author Jan Christian Dittmer (jcd)
 * \date Apr 13, 2015
 *///-------------------------------------------------------------------
#ifndef IBEOSDK_COMMANDLUXSETNTPTIMESTAMPSYNC_HPP_SEEN
#define IBEOSDK_COMMANDLUXSETNTPTIMESTAMPSYNC_HPP_SEEN
...
class CommandLuxSetNtpTimestampSync : public ibeosdk::LuxCommand<CommandId::CmdLuxSetNTPTimestampSync>,
...
public:
	CommandLuxSetNtpTimestampSync(const NTPTime timestamp);
...
#endif // IBEOSDK_COMMANDLUXSETNTPTIMESTAMPSYNC_HPP_SEEN
