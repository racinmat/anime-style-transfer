//======================================================================
/*! \file CommandMiniLuxGetParameter.hpp
 *
 * \copydoc Copyright
 * \author Jan Christian Dittmer (jcd)
 * \date Apr 10, 2015
 *///-------------------------------------------------------------------
#ifndef IBEOSDK_COMMANDMINILUXGETPARAMETER_HPP_SEEN
#define IBEOSDK_COMMANDMINILUXGETPARAMETER_HPP_SEEN
...
class CommandMiniLuxGetParameter : public ibeosdk::MiniLuxCommand<CommandId::CmdLuxGetParameter>,
                                   public ibeosdk::DataBlock {
public:
	//========================================
	/*!\brief Length of the SetFilter command.
	 *///-------------------------------------
	static const int commandSize = 6;

public:
	CommandMiniLuxGetParameter(const ParameterIndex parameterIndex);
...
#endif // IBEOSDK_COMMANDMINILUXGETPARAMETER_HPP_SEEN
