//======================================================================
/*! \file CommandMiniLuxReset.hpp
 *
 * \copydoc Copyright
 * \author Jan Christian Dittmer (jcd)
 * \date Apr 10, 2015
 *///-------------------------------------------------------------------
#ifndef IBEOSDK_COMMANDMINILUXRESET_HPP_SEEN
#define IBEOSDK_COMMANDMINILUXRESET_HPP_SEEN
...
class CommandMiniLuxReset : public ibeosdk::MiniLuxCommand<CommandId::CmdLuxReset>,
...
#endif // IBEOSDK_COMMANDMINILUXRESET_HPP_SEEN
