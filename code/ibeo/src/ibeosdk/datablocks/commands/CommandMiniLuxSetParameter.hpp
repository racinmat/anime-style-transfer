//======================================================================
/*! \file CommandMiniLuxSetParameter.hpp
 *
 * \copydoc Copyright
 * \author Jan Christian Dittmer (jcd)
 * \date Apr 10, 2015
 *///-------------------------------------------------------------------
#ifndef IBEOSDK_COMMANDMINILUXSETPARAMETER_HPP_SEEN
#define IBEOSDK_COMMANDMINILUXSETPARAMETER_HPP_SEEN
...
class CommandMiniLuxSetParameter : public ibeosdk::MiniLuxCommand<CommandId::CmdLuxSetParameter>,
                                   public ibeosdk::DataBlock {
public:
	//========================================
	/*!\brief Length of the SetFilter command.
	 *///-------------------------------------
	static const int commandSize = 10;

public:
	CommandMiniLuxSetParameter(const ParameterIndex parameterIndex,
...
#endif // IBEOSDK_COMMANDMINILUXSETPARAMETER_HPP_SEEN
