//======================================================================
/*! \file CommandLuxGetParameter.hpp
 *
 * \copydoc Copyright
 * \author Jan Christian Dittmer (jcd)
 * \date Apr 10, 2015
 *///-------------------------------------------------------------------
#ifndef IBEOSDK_COMMANDLUXGETPARAMETER_HPP_SEEN
#define IBEOSDK_COMMANDLUXGETPARAMETER_HPP_SEEN
...
class CommandLuxGetParameter : public ibeosdk::LuxCommand<CommandId::CmdLuxGetParameter>,
...
public:
	CommandLuxGetParameter(const ParameterIndex parameterIndex);
...
#endif // IBEOSDK_COMMANDLUXGETPARAMETER_HPP_SEEN
