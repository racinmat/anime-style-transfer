...
tf.flags.DEFINE_string('cpdir', '/datagrid/personal/racinmat/anime-style-transfer/checkpoint', 'Toplevel checkpoint dir')
...
tf.flags.DEFINE_string('gpu_idx', 0, 'GPU with which to run the network')
