...
def main(_):
    ...
    out = Conv2D(8, kernel_size=(5, 5), strides=(2, 2), activation='elu', padding='same')(input_tensor)
    out = Conv2D(16, kernel_size=(5, 5), strides=(2, 2), activation='elu', padding='same')(out)
    out = Conv2D(24, kernel_size=(5, 5), strides=(2, 2), activation='elu', padding='same')(out)
    out = Conv2D(32, kernel_size=(5, 5), strides=(2, 2), activation='elu', padding='same')(out)
    out = Conv2D(48, kernel_size=(5, 5), strides=(2, 2), activation='elu', padding='same')(out)
    out = Flatten()(out)
